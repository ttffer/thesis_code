...
foreach x $file_list {
    ...
    set file_root_folder [format %s "/home/kuanyu/Desktop/TCB_test/Different_net/tcb_axi_stream_succeed/py_fashionMNIST/py"]
...
#exit
#vivado -mode tcl -source ../tcl/run_sim.tcl 